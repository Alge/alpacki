...
pub fn encode(data: BitArray, accumulated: BitArray) -> BitArray {
  case data {
    <<0, remaining:bytes>> -> encode(remaining, <<accumulated:bits, 0x1ff8:13>>)
    <<1, remaining:bytes>> ->
    ...
    <<32, remaining:bytes>> -> encode(remaining, <<accumulated:bits, 0x14:6>>)
    <<33, remaining:bytes>> -> encode(remaining, <<accumulated:bits, 0x3f8:10>>)
    <<34, remaining:bytes>> -> encode(remaining, <<accumulated:bits, 0x3f9:10>>)
    <<35, remaining:bytes>> -> encode(remaining, <<accumulated:bits, 0xffa:12>>)
    <<36, remaining:bytes>> ->
      encode(remaining, <<accumulated:bits, 0x1ff9:13>>)
    <<37, remaining:bytes>> -> encode(remaining, <<accumulated:bits, 0x15:6>>)
    <<38, remaining:bytes>> -> encode(remaining, <<accumulated:bits, 0xf8:8>>)
    <<39, remaining:bytes>> -> encode(remaining, <<accumulated:bits, 0x7fa:11>>)
    <<40, remaining:bytes>> -> encode(remaining, <<accumulated:bits, 0x3fa:10>>)
    <<41, remaining:bytes>> -> encode(remaining, <<accumulated:bits, 0x3fb:10>>)
    <<42, remaining:bytes>> -> encode(remaining, <<accumulated:bits, 0xf9:8>>)
    <<43, remaining:bytes>> -> encode(remaining, <<accumulated:bits, 0x7fb:11>>)
    <<44, remaining:bytes>> -> encode(remaining, <<accumulated:bits, 0xfa:8>>)
    <<45, remaining:bytes>> -> encode(remaining, <<accumulated:bits, 0x16:6>>)
    <<46, remaining:bytes>> -> encode(remaining, <<accumulated:bits, 0x17:6>>)
    <<47, remaining:bytes>> -> encode(remaining, <<accumulated:bits, 0x18:6>>)
    <<48, remaining:bytes>> -> encode(remaining, <<accumulated:bits, 0x0:5>>)
    <<49, remaining:bytes>> -> encode(remaining, <<accumulated:bits, 0x1:5>>)
    <<50, remaining:bytes>> -> encode(remaining, <<accumulated:bits, 0x2:5>>)
    <<51, remaining:bytes>> -> encode(remaining, <<accumulated:bits, 0x19:6>>)
    <<52, remaining:bytes>> -> encode(remaining, <<accumulated:bits, 0x1a:6>>)
    <<53, remaining:bytes>> -> encode(remaining, <<accumulated:bits, 0x1b:6>>)
    <<54, remaining:bytes>> -> encode(remaining, <<accumulated:bits, 0x1c:6>>)
    <<55, remaining:bytes>> -> encode(remaining, <<accumulated:bits, 0x1d:6>>)
    <<56, remaining:bytes>> -> encode(remaining, <<accumulated:bits, 0x1e:6>>)
    <<57, remaining:bytes>> -> encode(remaining, <<accumulated:bits, 0x1f:6>>)
    <<58, remaining:bytes>> -> encode(remaining, <<accumulated:bits, 0x5c:7>>)
    <<59, remaining:bytes>> -> encode(remaining, <<accumulated:bits, 0xfb:8>>)
    <<60, remaining:bytes>> ->
      encode(remaining, <<accumulated:bits, 0x7ffc:15>>)
    <<61, remaining:bytes>> -> encode(remaining, <<accumulated:bits, 0x20:6>>)
    <<62, remaining:bytes>> -> encode(remaining, <<accumulated:bits, 0xffb:12>>)
    <<63, remaining:bytes>> -> encode(remaining, <<accumulated:bits, 0x3fc:10>>)
    <<64, remaining:bytes>> ->
      encode(remaining, <<accumulated:bits, 0x1ffa:13>>)
    <<65, remaining:bytes>> -> encode(remaining, <<accumulated:bits, 0x21:6>>)
    <<66, remaining:bytes>> -> encode(remaining, <<accumulated:bits, 0x5d:7>>)
    <<67, remaining:bytes>> -> encode(remaining, <<accumulated:bits, 0x5e:7>>)
    <<68, remaining:bytes>> -> encode(remaining, <<accumulated:bits, 0x5f:7>>)
    <<69, remaining:bytes>> -> encode(remaining, <<accumulated:bits, 0x60:7>>)
    <<70, remaining:bytes>> -> encode(remaining, <<accumulated:bits, 0x61:7>>)
    <<71, remaining:bytes>> -> encode(remaining, <<accumulated:bits, 0x62:7>>)
    <<72, remaining:bytes>> -> encode(remaining, <<accumulated:bits, 0x63:7>>)
    <<73, remaining:bytes>> -> encode(remaining, <<accumulated:bits, 0x64:7>>)
    <<74, remaining:bytes>> -> encode(remaining, <<accumulated:bits, 0x65:7>>)
    <<75, remaining:bytes>> -> encode(remaining, <<accumulated:bits, 0x66:7>>)
    <<76, remaining:bytes>> -> encode(remaining, <<accumulated:bits, 0x67:7>>)
    <<77, remaining:bytes>> -> encode(remaining, <<accumulated:bits, 0x68:7>>)
    <<78, remaining:bytes>> -> encode(remaining, <<accumulated:bits, 0x69:7>>)
    <<79, remaining:bytes>> -> encode(remaining, <<accumulated:bits, 0x6a:7>>)
    <<80, remaining:bytes>> -> encode(remaining, <<accumulated:bits, 0x6b:7>>)
    <<81, remaining:bytes>> -> encode(remaining, <<accumulated:bits, 0x6c:7>>)
    <<82, remaining:bytes>> -> encode(remaining, <<accumulated:bits, 0x6d:7>>)
    <<83, remaining:bytes>> -> encode(remaining, <<accumulated:bits, 0x6e:7>>)
    <<84, remaining:bytes>> -> encode(remaining, <<accumulated:bits, 0x6f:7>>)
    <<85, remaining:bytes>> -> encode(remaining, <<accumulated:bits, 0x70:7>>)
    <<86, remaining:bytes>> -> encode(remaining, <<accumulated:bits, 0x71:7>>)
    <<87, remaining:bytes>> -> encode(remaining, <<accumulated:bits, 0x72:7>>)
    <<88, remaining:bytes>> -> encode(remaining, <<accumulated:bits, 0xfc:8>>)
    <<89, remaining:bytes>> -> encode(remaining, <<accumulated:bits, 0x73:7>>)
    <<90, remaining:bytes>> -> encode(remaining, <<accumulated:bits, 0xfd:8>>)
    <<91, remaining:bytes>> ->
    ...
    <<95, remaining:bytes>> -> encode(remaining, <<accumulated:bits, 0x22:6>>)
    <<96, remaining:bytes>> ->
      encode(remaining, <<accumulated:bits, 0x7ffd:15>>)
    <<97, remaining:bytes>> -> encode(remaining, <<accumulated:bits, 0x3:5>>)
    <<98, remaining:bytes>> -> encode(remaining, <<accumulated:bits, 0x23:6>>)
    <<99, remaining:bytes>> -> encode(remaining, <<accumulated:bits, 0x4:5>>)
    <<100, remaining:bytes>> -> encode(remaining, <<accumulated:bits, 0x24:6>>)
    <<101, remaining:bytes>> -> encode(remaining, <<accumulated:bits, 0x5:5>>)
    <<102, remaining:bytes>> -> encode(remaining, <<accumulated:bits, 0x25:6>>)
    <<103, remaining:bytes>> -> encode(remaining, <<accumulated:bits, 0x26:6>>)
    <<104, remaining:bytes>> -> encode(remaining, <<accumulated:bits, 0x27:6>>)
    <<105, remaining:bytes>> -> encode(remaining, <<accumulated:bits, 0x6:5>>)
    <<106, remaining:bytes>> -> encode(remaining, <<accumulated:bits, 0x74:7>>)
    <<107, remaining:bytes>> -> encode(remaining, <<accumulated:bits, 0x75:7>>)
    <<108, remaining:bytes>> -> encode(remaining, <<accumulated:bits, 0x28:6>>)
    <<109, remaining:bytes>> -> encode(remaining, <<accumulated:bits, 0x29:6>>)
    <<110, remaining:bytes>> -> encode(remaining, <<accumulated:bits, 0x2a:6>>)
    <<111, remaining:bytes>> -> encode(remaining, <<accumulated:bits, 0x7:5>>)
    <<112, remaining:bytes>> -> encode(remaining, <<accumulated:bits, 0x2b:6>>)
    <<113, remaining:bytes>> -> encode(remaining, <<accumulated:bits, 0x76:7>>)
    <<114, remaining:bytes>> -> encode(remaining, <<accumulated:bits, 0x2c:6>>)
    <<115, remaining:bytes>> -> encode(remaining, <<accumulated:bits, 0x8:5>>)
    <<116, remaining:bytes>> -> encode(remaining, <<accumulated:bits, 0x9:5>>)
    <<117, remaining:bytes>> -> encode(remaining, <<accumulated:bits, 0x2d:6>>)
    <<118, remaining:bytes>> -> encode(remaining, <<accumulated:bits, 0x77:7>>)
    <<119, remaining:bytes>> -> encode(remaining, <<accumulated:bits, 0x78:7>>)
    <<120, remaining:bytes>> -> encode(remaining, <<accumulated:bits, 0x79:7>>)
    <<121, remaining:bytes>> -> encode(remaining, <<accumulated:bits, 0x7a:7>>)
    <<122, remaining:bytes>> -> encode(remaining, <<accumulated:bits, 0x7b:7>>)
    <<123, remaining:bytes>> ->
